...
log = structlog.get_logger("koel.briefs.extract")
...
def extract_pdf_text(data: bytes) -> str:
    ...
    Uses ``pypdf`` when installed (``pip install 'koel[briefs]'``). Without
    ...
    try:
        ...
        log.warning(
            "pypdf_unavailable",
            hint="pip install 'koel[briefs]' for PDF text extraction",
        )
        return ""
