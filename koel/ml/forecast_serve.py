...
from koel.ml.iterate import _enrich_cross_section, _predict_lmt_bagged
...
def _load_gate_threshold(*, p90: bool = False) -> float:
    if p90:
        from koel.ml.symbol_gate import load_symbol_gate
...
async def run_unified_forecast(
    *,
    ...
    if mode in LTR_MODES:
        from koel.ml.ltr_serve import build_ltr_panels, write_ltr_gated_forecasts
