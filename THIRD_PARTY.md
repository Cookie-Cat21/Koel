...
Koel installs packages from PyPI (or equivalent); we do **not** vendor
...
| [pypdf](https://github.com/py-pdf/pypdf) | BSD-3-Clause | PDF text extraction for filing briefs (`koel[briefs]`) |
