"""CSE financial PDF extract core (promoted from research spike).

Used by ``chime.extractors.financial_pdf`` for filing metrics. Keep behavior
aligned with ``scripts/experiments/cse_financial_accuracy_eval.py``.
"""
