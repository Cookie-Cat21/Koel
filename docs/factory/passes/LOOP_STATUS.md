...
| Metric | Value |
|---|---|
| Waves completed | **16** (`wave` / `waveN` / `wN` through w16) |
| This status push | **w17** (docs only) |
...
1. Spawn w17+ harden/ops lanes inside product fences (not cov padding).
