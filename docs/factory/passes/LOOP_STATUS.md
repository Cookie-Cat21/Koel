...
| Metric | Value |
|---|---|
| Waves completed | **25** (`wave` / `waveN` / `wN` through w25) |
| This status push | **w26** (docs only) |
| Commits ahead of `main` | **167** |
...
1. Spawn w26+ harden/ops lanes inside product fences (not cov padding).
