...
| Metric | Value |
|---|---|
| Waves completed | **27** (`wave` / `waveN` / `wN` through w27) |
| This status push | **w28** (docs only) |
...
1. Spawn w28+ harden/ops lanes inside product fences (not cov padding).
