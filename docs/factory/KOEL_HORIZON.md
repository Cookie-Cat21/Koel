...
**One-liner:** CSE market **dashboard** (cake) + **Telegram push** when rules fire (cherry). See [DASH_CAKE_CHERRY.md](DASH_CAKE_CHERRY.md) and the full max roadmap [KOEL_MASTER_PLAN.md](KOEL_MASTER_PLAN.md).
